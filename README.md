...
│
├── 📓 bankruptcy-eda-model.ipynb # Complete EDA + preprocessing + model training
├── 📄 train.csv # Training dataset (not uploaded if private)
├── 📄 test.csv # Test dataset (not uploaded if private)
├── 📄 submission_final_hackathon.csv # Final submission file (alive/failed)
├── 📄 report.tex # LaTeX report file
├── 📄 README.md # Project documentation (this file)
└── 📂 figures/ # Optional: plots (EDA, threshold tuning, etc.)
```
...
- Encoded target labels: `alive → 0`, `failed → 1`
...
Rather than using the default 0.5 cutoff, precision–recall analysis was used to maximize Macro-F1:
...
## 🧠 Key Learnings
 ...
 - XGBoost’s scale_pos_weight handled class imbalance better than SMOTE in this case.
...
### 👤 Author
 ...
 - 📧 Contact: [email](24je0702@iitism.ac.in)
